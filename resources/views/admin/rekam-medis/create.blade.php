...
<x-admin.form
    ...
    subtitle="Isi rekam medis untuk jadwal konsultasi yang sudah selesai."
    backUrl="{{ route('admin.rekam-medis.index') }}">
    ...
    <div class="grid grid-cols-1 gap-6">
        ...
        <div class="space-y-2">
            ...
            <p class="text-[12px] text-slate-400">
                Tidak ada jadwal selesai yang belum memiliki rekam medis.
            </p>
            @endif
        </div>
        ...
        <div class="space-y-2">
            ...
            <textarea id="keluhan" name="keluhan" rows="3"
                class="w-full px-4 py-3 rounded-[12px] border border-slate-200 focus:outline-none focus:ring-2 focus:ring-slate-500/20 focus:border-slate-500 text-[14px] transition-all resize-none"
