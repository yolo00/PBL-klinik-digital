...
<div class="space-y-6 max-w-2xl">
    <div class="mb-6 flex items-center gap-2">
        ...
        <h3 class="text-xl font-bold text-slate-800">Edit Spesialisasi</h3>
    </div>

    <div class="bg-white rounded-[24px] shadow-sm border border-slate-100 p-8">
        <form action="{{ route('admin.spesialisasi.update', $spesialisasi) }}" method="POST">
            @csrf
            @method('PUT')
            
            <div class="mb-6">
                <label for="nama" class="block text-sm font-bold text-slate-700 mb-2">Nama Spesialisasi</label>
                <input type="text" name="nama" id="nama" value="{{ old('nama', $spesialisasi->nama) }}" required placeholder="Contoh: Dokter Jantung"
            ...
            <div class="mb-8">
                ...
                <div class="relative">
                    ...
                    <input type="number" name="base_price" id="base_price" value="{{ old('base_price', intval($spesialisasi->base_price)) }}" required min="0" step="1000"
