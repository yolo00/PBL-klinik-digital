        ...
        <header class="border-b border-slate-200 bg-white/90 backdrop-blur-sm">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
                ...
                <nav class="flex items-center gap-4 text-sm font-medium text-slate-700">
                    <a href="{{ route('home') }}" class="text-slate-900 hover:text-sky-600">Home</a>
                    <a href="{{ route('about') }}" class="hover:text-sky-600">About</a>
                    <a href="{{ route('login') }}" class="rounded-full bg-emerald-600 px-4 py-2 text-white hover:bg-emerald-700">Login</a>
                </nav>
            </div>
        </header>
