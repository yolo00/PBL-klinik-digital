        ...
        <form action="{{ route('register.submit') }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-5">
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}" required placeholder="Masukkan nama" class="w-full rounded-[20px] border border-slate-200 bg-slate-50 px-5 py-3.5 text-[15px] text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white transition-all shadow-sm" />
                </div>
            ...
            <div class="grid grid-cols-2 gap-5">
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="text" name="nimnik" value="{{ old('nimnik') }}" required placeholder="Masukkan NIM/NIK" class="w-full rounded-[20px] border border-slate-200 bg-slate-50 px-5 py-3.5 text-[15px] text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white transition-all shadow-sm" />
                </div>

                <div class="col-span-2 md:col-span-1">
                    <label class="mb-1.5 block text-[15px] font-semibold text-slate-700">Tanggal Lahir</label>
                    <div class="relative">
                        <input type="date" name="tgl_lahir" value="{{ old('tgl_lahir') }}" required class="w-full rounded-[20px] border border-slate-200 bg-slate-50 px-5 py-3.5 text-[15px] text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white transition-all shadow-sm cursor-pointer" style="color-scheme: light;" />
                    </div>
                </div>
            </div>
