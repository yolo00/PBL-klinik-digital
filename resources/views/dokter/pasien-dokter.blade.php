...
<div class="mb-10">
    ...
    <p class="text-slate-400 font-medium mt-1">Lihat data semua pasien dan kelola riwayat rekam medis mereka.</p>
</div>
...
<div class="bg-white rounded-[40px] border border-slate-100 shadow-sm overflow-hidden p-8 md:p-10">
    ...
    <div class="mb-8 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
            <div class="md:col-span-6 relative group">
                ...
                <input type="text" placeholder="Cari nama atau NIK pasien..." class="w-full pl-14 pr-6 py-4 bg-slate-50 rounded-2xl border-none focus:ring-2 focus:ring-emerald-500/20 text-sm font-medium transition-all outline-none">
            </div>
   ...
   class="inline-block px-6 py-2.5 bg-slate-800 text-white rounded-xl text-[10px] font-black uppercase hover:bg-emerald-600 transition-all shadow-md text-center tracking-wider">
    <i class="fa-solid fa-notes-medical mr-1.5"></i> Rekam Medis
</a>
                        </div>
                    </td>
                </tr>
