...
<div class="mb-10">
    <div class="flex items-center gap-4 mb-2">
        <a href="{{ route('dokter.dashboard') }}" class="w-10 h-10 bg-white rounded-xl border border-slate-100 flex items-center justify-center text-slate-400 hover:text-emerald-500 transition-all shadow-sm">
            <i class="fa-solid fa-arrow-left"></i>
        </a>
        <h1 class="text-[32px] font-black text-slate-800 leading-tight">Profil Dokter</h1>
    </div>
...
<div class="bg-white rounded-[40px] border border-slate-100 shadow-sm overflow-hidden p-8 md:p-12">
    ...
    <div class="flex flex-col md:flex-row items-center gap-8 mb-12 pb-12 border-b border-slate-50">
        ...
        <div class="text-center md:text-left">
            <h2 class="text-2xl font-black text-slate-800 mb-1">Fenni Patrik Simanjuntak</h2>
            <p class="text-emerald-500 font-black uppercase tracking-[2px] text-[11px] mb-4">Dokter Umum (Dr.)</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="space-y-2">
            ...
            <input type="email" value="feynsiber26@gmail.com" readonly class="w-full px-6 py-4 bg-slate-50 rounded-2xl border-none text-slate-800 font-bold outline-none cursor-default">
        </div>

        <div class="space-y-2">
            <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Spesialis</label>
            <input type="text" value="Dokter Umum (Dr.)" readonly class="w-full px-6 py-4 bg-slate-50 rounded-2xl border-none text-slate-800 font-bold outline-none cursor-default">
        </div>

        <div class="space-y-2">
            <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Tanggal Lahir</label>
            <input type="text" value="17 Agustus 1945" readonly class="w-full px-6 py-4 bg-slate-50 rounded-2xl border-none text-slate-800 font-bold outline-none cursor-default">
        </div>
        ...
        <div class="space-y-2 md:col-span-2">
            ...
            <input type="text" value="087767351842" readonly class="w-full px-6 py-4 bg-slate-50 rounded-2xl border-none text-slate-800 font-bold outline-none cursor-default">
        </div>
    </div>
