<?php $__env->startSection('title', 'UniHealth | Home'); ?>
        ...
        <div class="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            <div class="space-y-6">
                ...
                <div class="flex flex-col gap-4 sm:flex-row">
                    <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-7 py-3 text-base font-semibold text-white shadow-sm hover:bg-emerald-700">Login</a>
                    <a href="<?php echo e(route('about')); ?>" class="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-7 py-3 text-base font-semibold text-slate-900 hover:bg-slate-50">Learn More</a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KlinikDigital\resources\views/welcome.blade.php ENDPATH**/ ?>