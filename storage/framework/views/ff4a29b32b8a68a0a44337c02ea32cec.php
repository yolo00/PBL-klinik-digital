<?php $__env->startSection('title', 'Daftar | UniHealth'); ?>
    ...
    <section class="mx-auto max-w-lg rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
        <div class="space-y-6">
            ...
            <p class="text-center text-sm text-slate-500">
                Sudah punya akun?
                <a href="<?php echo e(route('login')); ?>" class="font-semibold text-emerald-600 hover:text-emerald-700">Masuk di sini</a>
            </p>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\SEM2\PBL\PBL-klinik-digital\resources\views/register.blade.php ENDPATH**/ ?>